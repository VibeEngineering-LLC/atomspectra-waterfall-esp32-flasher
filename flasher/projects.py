...
PROJECT_REGISTRY = {
    ...
    # прошивкой автоматически: USB, если прибор воткнут, иначе BLE (есть
    # выключатель Bluetooth). MAC прибора в бинарник не зашит: плата ищет
    # Radex в эфире сама, поэтому один общий образ годится всем.
    "radex-gateway": Project(
        key="radex-gateway",
        title="Radex Gateway, BLE и USB (ESP32-S3 N16R8)",
        chip="esp32s3",
        flash_mode="dio",
        flash_freq="80m",
        flash_size="detect",
